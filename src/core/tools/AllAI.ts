...
// AI工具状态接口
export interface AllAIState {
  generalAI: Ref<AITool[]>;
  writingAI: Ref<AITool[]>;
  devAI: Ref<AITool[]>;
  artAI: Ref<AITool[]>;
  otherAI: Ref<AITool[]>;
}
 ...
 * @returns AllAI状态和方法
 */
export function useAllAI(): AllAIState & {
  openUrl: (url: string) => void;
} {
  // 创建响应式状态
  const state: AllAIState = {
